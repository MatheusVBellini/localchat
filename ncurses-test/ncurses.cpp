...
WINDOW* layoutHeader(int y_beg, int x_beg, int y_max, int x_max) {
...
WINDOW* layoutChatBox(int y_beg, int x_beg, int y_max, int x_max) {
...
WINDOW* layoutMsgBox(int y_beg, int x_beg, int y_max, int x_max) {
